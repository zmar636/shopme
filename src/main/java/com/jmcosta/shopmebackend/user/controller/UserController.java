...
public class UserController {
    ...
    public String delete(
        ...
        try {
            ...
            redirectAttributes
                    .addFlashAttribute("message", "User with id: \"" + id + "\" has been deleted successfully");
        } catch (UserNotFoundException ex) {
            redirectAttributes.addFlashAttribute("message", ex.getMessage());
        }
        return "redirect:/users";
    ...
    public String updateEnabledStatus(
            ...
            RedirectAttributes redirectAttributes) {
        try {
            userService.updateEnableStatus(id, status);
            String message = "User with id: " + id + " has been " + (status ? "enabled" : "disabled");
